...
class TeamOverviewSpec(unittest.TestCase):
    def setUp(self):
        self.data = eashltoolkit.html.team.find_team(fixtures_json.stats)
...
class GetResultsSpec(unittest.TestCase):
    def it_should_form_correct_url_for_match_results_ps3(self):
        ...
        url = eashltoolkit.html.team.get_results_url("26")
    ...
    def it_should_find_first_match_summary(self):
        self.data = eashltoolkit.html.team.parse_results_data(fixtures_json.results, "26")
    ...
    def it_should_handle_bad_data(self):
        self.data = eashltoolkit.html.team.parse_results_data('[]', "26")
...
class FindTeamsSpec(unittest.TestCase):
    def it_should_find_teams_by_abbreviation(self):
        ...
        results = eashltoolkit.html.team.find_teams("ice")
        self.assertEqual(10, len(results))   
        
    def it_shoould_form_correct_search_url_for_xbox(self):
        eashltoolkit.settings.SYSTEM = "XBOX"
        url = eashltoolkit.html.team.create_search_url("ice")
