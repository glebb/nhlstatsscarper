...
class ParseTeamOverviewSpec(unittest.TestCase):
    def setUp(self):
        self.data = eanhlstats.html.parse_team_overview_data(fixtures.murohoki_overview)
        self.data2 = eanhlstats.html.parse_team_overview_data(fixtures_xbox.xbx_overview)
    ...
    def it_should_return_empty_string_without_good_data(self):
        self.data = eanhlstats.html.parse_team_overview_data("")
...
class GetTeamUrlSpec(unittest.TestCase):
    ...
    def it_should_find_url_with_good_html(self):
        url = eanhlstats.html.get_team_url(fixtures.murohoki_search)
    ...
    def it_should_not_find_url_with_bad_html(self):
        url = eanhlstats.html.get_team_url("")
        self.assertEqual(url, None)
    
    def it_should_not_find_url_with_partly_good_html(self):
        url = eanhlstats.html.get_team_url('<table class="styled full-width"></table>')
        self.assertEqual(url, None)
        
    def it_should_find_third_url_from_list_of_many_urls(self):
        url = eanhlstats.html.get_team_url(fixtures.many_search_results, 3)
...
class CreateSearchUrlSpec(unittest.TestCase):
    ...
    def it_creates_search_url_for_team_name_with_spaces(self):
        eanhlstats.settings.SYSTEM = "PS3"
        val = eanhlstats.html.create_search_url("murohoki blaah")
    ...
    def it_works_with_empty_param(self):
        eanhlstats.settings.SYSTEM = "PS3"
        val = eanhlstats.html.create_search_url("")
...
class getTeamOverviewHtmlSpec(unittest.TestCase):
    def it_should_store_team_data_to_db(self):
        ...
        fake_team = Team()
        fake_team.eaid = "0"
        eanhlstats.html.save_new_team_to_db = MagicMock(return_value=fake_team)
        eanhlstats.html.get_content = MagicMock(return_value=None)
        html = eanhlstats.html.get_team_overview_html(team_name)
        eanhlstats.html.save_new_team_to_db.assert_called_with(team_name)
